...
namespace TQ_weaponsmith
{
  internal class AboutBox : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.tableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 36.79245f));
      this.tableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 63.20755f));
      ...
      this.textBoxDescription.Size = new Size((int) byte.MaxValue, 126);
      this.textBoxDescription.TabIndex = 23;
      this.textBoxDescription.TabStop = false;
      this.textBoxDescription.Text = "Thanks to THQ Nordic for such an adictive game!!\r\n\r\nFor any suggestions maill at koderkrazy@gmail.com\r\n";
      this.logoPictureBox.BackgroundImage = (Image) Resources.AboutPageArt;
      this.logoPictureBox.BackgroundImageLayout = ImageLayout.Stretch;
      this.logoPictureBox.Dock = DockStyle.Fill;
      this.logoPictureBox.InitialImage = (Image) null;
      this.logoPictureBox.Location = new Point(3, 3);
      this.logoPictureBox.Name = "logoPictureBox";
      this.tableLayoutPanel.SetRowSpan((Control) this.logoPictureBox, 6);
      this.logoPictureBox.Size = new Size(147, 259);
      this.logoPictureBox.SizeMode = PictureBoxSizeMode.StretchImage;
      this.logoPictureBox.TabIndex = 12;
      this.logoPictureBox.TabStop = false;
      this.labelProductName.Dock = DockStyle.Fill;
      this.labelProductName.Font = new Font("Microsoft Sans Serif", 8.25f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
      this.labelProductName.Location = new Point(159, 0);
      this.labelProductName.Margin = new Padding(6, 0, 3, 0);
      this.labelProductName.MaximumSize = new Size(0, 17);
      this.labelProductName.Name = "labelProductName";
      this.labelProductName.Size = new Size((int) byte.MaxValue, 17);
      this.labelProductName.TabIndex = 19;
      this.labelProductName.Text = "TQ_Blacksmith";
      this.labelProductName.TextAlign = ContentAlignment.MiddleLeft;
      this.labelVersion.Dock = DockStyle.Fill;
      this.labelVersion.Location = new Point(159, 26);
      this.labelVersion.Margin = new Padding(6, 0, 3, 0);
      this.labelVersion.MaximumSize = new Size(0, 17);
      this.labelVersion.Name = "labelVersion";
      this.labelVersion.Size = new Size((int) byte.MaxValue, 17);
      this.labelVersion.TabIndex = 0;
      this.labelVersion.Text = "V 0.1  5-2018";
      this.labelVersion.TextAlign = ContentAlignment.MiddleLeft;
      this.labelCopyright.Dock = DockStyle.Fill;
      this.labelCopyright.Location = new Point(159, 52);
      this.labelCopyright.Margin = new Padding(6, 0, 3, 0);
      this.labelCopyright.MaximumSize = new Size(0, 17);
      this.labelCopyright.Name = "labelCopyright";
      this.labelCopyright.Size = new Size((int) byte.MaxValue, 17);
