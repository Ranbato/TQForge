...
import unused.util.ddsutil.ImageRescaler;
import unused.util.ddsutil.MipMapsUtil;
import unused.util.ddsutil.NonCubicDimensionException;
import unused.util.ddsutil.Rescaler;
