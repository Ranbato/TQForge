...
public class BIUtil {
	...
	/**
	 * Extracts the specified {@link ImageOperations.ChannelMode} from a {@link BufferedImage}
	 * and returns it in a new {@link BufferedImage} 
	 * @param sourceBi
	 * @param channelMode
	 * @return
	 */
	public static BufferedImage getChannel(final BufferedImage sourceBi, final ImageOperations.ChannelMode channelMode) {
...
//				ColorModel color = sourceBi.getColorModel();
	...
	/**
	 * Extracts the Alpha channel from a {@link ImageOperations.ChannelMode}
	 * and returns it in a new BufferedImage
	 * @param sourceBi
	 * @return
	 */
	public static Image getAlphaChannel(final BufferedImage sourceBi) {	
		return getChannel(sourceBi, ImageOperations.ChannelMode.ALPHA);
	}
